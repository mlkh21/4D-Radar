...
PROJECT_ROOT = Path("/home/zxj/catkin_ws/src/4D-Radar-Diffusion").resolve()
...
vae_ckpt = os.environ.get("VAE_CKPT", "/home/zxj/catkin_ws/src/4D-Radar-Diffusion/test/mini-test/train_results_mini_near/vae/vae_best.pt")

data_root = os.environ.get("DATA_ROOT", "/home/zxj/catkin_ws/src/4D-Radar-Diffusion/Data/NTU4DRadLM_Pre_near40_soft")
...
out_dir = os.path.join("test/result", "vae_iou_eval", scene)
