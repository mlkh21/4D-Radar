...
class MultimodalFusionTest(unittest.TestCase):
    ...
    def test_projection_masks_invalid_frustum_and_fusion_outputs_sixteen_channels(self):
        ...
        projected_with_mask, frustum_mask = projection(
            ir_features,
            r_mat,
            t_vec,
            k_mat,
        ...
        self.assertEqual(tuple(projected_with_mask.shape), (1, 32, 2, 2, 2))
        self.assertEqual(tuple(frustum_mask.shape), (1, 1, 2, 2, 2))
        self.assertEqual(frustum_mask.dtype, torch.bool)
        ...
        self.assertEqual(latent_net.ir_gate[0].in_channels, 16 + 32 + 1)
        ...
        self.assertIsNotNone(latent_net.last_ir_frustum_mask)
        self.assertEqual(tuple(latent_net.last_ir_frustum_mask.shape), (1, 1, 2, 2, 2))
